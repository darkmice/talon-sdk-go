...
// conditional point-read v1, bounded same-snapshot read v1, leased conditional
// prefix-scan v1, and the versioned SQL/query surface with exact DECIMAL. It
// does not expose embedded DB operations or revision streams. Importing this
// package does not compile or link the native Talon library.
//
// # Exact DECIMAL
//
